...
export const insertCartSchema = z.object({
  ...
  userId: z.string().optional().nullable(), // optional because we want user fill the cart even if hes not logged in
});
...
export const insertReviewSchema = z.object({
  title: z.string().min(3, 'Title muse be at least 3 characters'),
  description: z.string().min(3, 'Description muse be at least 3 characters'),
  productId: z.string().min(1, 'Product is required'),
  userId: z.string().min(1, 'User is required'),
  rating: z.coerce
    .number()
