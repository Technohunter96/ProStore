...
const TARGET_DATE = new Date('2024-09-12T10:00:00+02:00');

// Function to calculate the time remaining
const calculateTimeRemaining = (targetDate: Date) => {
  const currentTime = new Date();
  const timeDifference = Math.max(Number(targetDate) - Number(currentTime), 0); // It will return left side as long as it's bigger than zero
  return {
