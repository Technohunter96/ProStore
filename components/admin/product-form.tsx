...
import { ControllerRenderProps, SubmitErrorHandler, useForm } from 'react-hook-form';
import { z } from 'zod';
...
const ProductForm = ({
  ...
  const form = useForm<z.infer<typeof insertProductSchema>>({
    ...
    defaultValues: product && type === 'Update' ? product : productDefaultValues, // if updating it will get product valuse, elseif creating it will get default values of product
  });

  const onSubmit: SubmitErrorHandler<z.infer<typeof insertProductSchema>> = async (values) => {
    // On Create
    if (type === 'Create') {
